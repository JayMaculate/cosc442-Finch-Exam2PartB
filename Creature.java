...
public class Creature {
	...
	public void moveBy(int mx, int my, int mz){
		...
		onEnterMethod(mx, my, mz, tile, other);
	}
	public void stairsDown(int mz, Tile tile) {
	...
	public void stairsUp(int mz, Tile tile) {
	...
	public void onEnterMethod(int mx, int my, int mz, Tile tile, Creature other) {
		if (other == null)
	...
	public void inventToryFull(Item item) {
		if (inventory.isFull()) {
